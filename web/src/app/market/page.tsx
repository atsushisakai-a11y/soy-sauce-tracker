...
const SHOP_META: Record<string, ShopMeta> = {
  "Dun Yong": {
    ...
    priceTag: "💛 Mid-range", selectionScore: 5, reliabilityScore: 5, overallScore: 5,
  },
  "Tjin's Toko": {
    flag: "🇳🇱", url: "https://www.tjinstoko.eu/en/search-per-category/condiments/soy-sauce/",
  ...
  "ACE Market": {
    ...
    priceTag: "💚 Cheapest", selectionScore: 4, reliabilityScore: 4, overallScore: 4,
  },
  "Shilla Market": {
    flag: "🇳🇱", url: "https://shillamarket.com",
    ...
    priceTag: "🔴 Premium", selectionScore: 3, reliabilityScore: 5, overallScore: 4,
  },
  "Amazing Oriental": {
    flag: "🇳🇱", url: "https://amazingoriental.com",
    ...
    priceTag: "💛 Mid-range", selectionScore: 3, reliabilityScore: 4, overallScore: 3,
  },
  "Oriental Webshop": {
    flag: "🇳🇱", url: "https://www.orientalwebshop.nl",
    ...
    priceTag: "💛 Mid-range", selectionScore: 3, reliabilityScore: 3, overallScore: 3,
  },
  "Toko Asia": {
    flag: "🇳🇱", url: "https://www.tokoazia.nl/Sojasaus",
    tagline: "Dutch online Asian supermarket with a solid soy sauce range.",
    strengths: ["Good brand variety", "Online convenience", "Kikkoman + Yamasa + LKK stocked", "Competitive pricing"],
    bestFor: "Online shoppers wanting a broad Asian product range alongside soy sauce",
    verdict: "Good online option covering all major brands at fair prices. Clean website and easy to navigate.",
    priceTag: "💛 Mid-range", selectionScore: 3, reliabilityScore: 4, overallScore: 3,
  },
  "Sligro": {
    flag: "🇳🇱", url: "https://www.sligro.nl/c.230.html/kruidenierswaren/sauzen-soepen-dressings/sauzen-toebehoren/ketjap-sojasauzen.html",
    ...
    verdict: "Sligro is a wholesale/foodservice supplier — not for regular consumers. If you run a restaurant or buy in bulk, they offer large-format soy sauce at competitive wholesale prices.",
    priceTag: "💚 Cheapest", selectionScore: 3, reliabilityScore: 5, overallScore: 3,
  },
  "PLUS": {
    flag: "🇳🇱", url: "https://www.plus.nl/zoekresultaten?SearchTerm=soja%20saus",
    tagline: "~500 locations across the Netherlands. Limited range, very convenient.",
    strengths: ["500+ stores nationwide", "Always in stock", "Convenient for quick purchase", "Competitive mainstream pricing"],
    bestFor: "Quick top-up purchases when you don't want to order online",
    verdict: "Limited to mainstream brands (mainly Kikkoman 250–500ml). If you just need a bottle quickly, PLUS almost certainly has one nearby.",
    priceTag: "💛 Mid-range", selectionScore: 2, reliabilityScore: 5, overallScore: 3,
  },
  "Wah Nam Hong": {
    flag: "🇳🇱", url: "https://www.wah-nam-hong.nl",
    ...
    priceTag: "💚 Cheapest", selectionScore: 3, reliabilityScore: 3, overallScore: 3,
  },
  "Albert Heijn": {
    flag: "🇳🇱", url: "https://www.ah.nl",
    ...
    priceTag: "🔴 Premium", selectionScore: 2, reliabilityScore: 5, overallScore: 3,
  },
  "Jumbo": {
    flag: "🇳🇱", url: "https://www.jumbo.com",
    ...
    priceTag: "🔴 Premium", selectionScore: 1, reliabilityScore: 4, overallScore: 2,
  },
  "NikanKitchen": {
    flag: "🇩🇪", url: "https://www.nikankitchen.com",
    ...
    priceTag: "🔴 Premium", selectionScore: 4, reliabilityScore: 4, overallScore: 3,
  },
};
...
export default async function MarketPage() {
  ...
  const bestOverall = [...shops].sort((a, b) => b.meta.overallScore - a.meta.overallScore)[0];
    ...
    <main className="min-h-screen bg-stone-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-12">
        ...
        <section className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold text-stone-900 mb-1">Where to Buy</h2>
          ...
          {bestOverall && (
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-base font-bold text-amber-800">{bestOverall.shop_name}</p>
                <p className="text-sm text-amber-700 mt-1">{bestOverall.meta.verdict}</p>
              </div>
            </div>
          )}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-6 text-xs text-stone-500">
                      <div><span className="text-stone-400 mr-1">Selection</span><Stars score={shop.meta.selectionScore} /></div>
                      <div><span className="text-stone-400 mr-1">Reliability</span><Stars score={shop.meta.reliabilityScore} /></div>
                      <div><span className="text-stone-400 mr-1">Overall</span><Stars score={shop.meta.overallScore} /></div>
                    </div>
                  </div>
                  {stats.length > 0 && (
                    <div className="text-right flex-shrink-0 hidden sm:block">
                      ...
                      <div className="text-xs text-stone-400 mt-1">{fmt(shop.cheapest_price)} – {fmt(shop.most_expensive)}</div>
