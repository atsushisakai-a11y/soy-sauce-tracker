...
const SHOP_META: Record<string, ShopMeta> = {
  "Dun Yong": {
    ...
    tagline: "Amsterdam's largest Asian supermarket. Widest selection, fair pricing.",
    strengths: ["Widest product range", "Many brands + sizes", "Physical stores available", "Regular stock"],
    bestFor: "Shoppers who want the best selection in one place",
    verdict: "Best all-rounder. Stocks everything from Kikkoman to artisan Japanese brands. Prices are fair and stock is reliable.",
    priceTag: "💛 Mid-range",
    selectionScore: 5,
    reliabilityScore: 5,
    overallScore: 5,
  ...
  "Tjin's Toko": {
    ...
    tagline: "Rotterdam's oldest Asian grocery. Great variety, competitive prices.",
    strengths: ["Very wide selection", "Multiple brands", "Competitive pricing", "Physical + online"],
    bestFor: "Rotterdam locals and variety seekers",
    verdict: "Excellent selection across all brands and sizes. One of the most comprehensive soy sauce ranges in the Netherlands at fair prices.",
    priceTag: "💛 Mid-range",
    selectionScore: 5,
    reliabilityScore: 4,
    overallScore: 4,
