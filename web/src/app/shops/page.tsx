...
const SHOP_META: Record<string, ShopMeta> = {
  ...
  "Toko Asia": {
    flag: "🇳🇱",
    url: "https://www.tokoazia.nl/Sojasaus",
  ...
  "PLUS": {
    ...
    verdict: "Limited to mainstream brands (mainly Kikkoman 250–500ml). If you just need a bottle quickly, PLUS almost certainly has one nearby. Not a destination for variety.",
    priceTag: "💛 Mid-range",
    selectionScore: 2,
    reliabilityScore: 5,
    overallScore: 3,
