  ...
  return (
    <main className="min-h-screen bg-stone-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        {/* Lineage embed CTA */}
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-100 rounded-2xl p-6 text-center space-y-3">
          <p className="text-2xl">🔀</p>
          <h3 className="font-semibold text-stone-800">Interactive Lineage DAG</h3>
